...
def winnerScreen(winner):
    ...
    while True:
        for event in pygame.event.get():
            ...
            if (display_width//2-75<=pos[0]<=(display_width//2-75)+50) and ((display_height//4)+75<=pos[1]<=((display_height//4)+25)+75):
                print("Yes")
                if pygame.mouse.get_pressed()[0] == 1:
                    gameReset()
                
            if (display_width//2+25<=pos[0]<=(display_width//2+25)+50) and ((display_height//4)+75<=pos[1]<=((display_height//4)+25)+75):
                print("No")
                if pygame.mouse.get_pressed()[0] == 1:
                    pygame.quit()
                    sys.exit()
